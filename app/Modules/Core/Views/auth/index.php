...
<p><?php echo anchor('auth/create_user', lang('Auth.index_create_user_link'))?> | <?php echo anchor('auth/create_group', lang('Auth.index_create_group_link'))?> | <?php echo anchor('auth/permission_list', lang('Auth.permission_list_heading')) ?></p>
